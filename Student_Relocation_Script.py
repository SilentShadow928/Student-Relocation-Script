"""
This is the Student Relocation Script.
Terminology:
...
This script takes data from a excel spreadsheet that is experted from a microsoft form.
...
Who else do you want to sit with? Answer in the same format as the previous question.
"""
#If you end up improving this script, please send a pull request to [Insert repo here]
print("Please wait...")
